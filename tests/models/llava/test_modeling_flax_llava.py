...
class FlaxLlavaForConditionalGenerationModelTest(FlaxModelTesterMixin, unittest.TestCase):
    ...
    def test_equivalence_pt_to_flax(self):
        ...
        # Load Flax model directly from the checkpoint (likely safetensors)
        fx_model = FlaxLlavaForConditionalGeneration.from_pretrained(model_id, dtype=jnp.float32) # Removed from_pt=True
