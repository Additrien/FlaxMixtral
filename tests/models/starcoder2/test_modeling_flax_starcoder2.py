...
from transformers import is_flax_available, Starcoder2Config
...
class FlaxStarcoder2ModelTester:
    def __init__(
        self,
        parent,
        batch_size=13,
    ...
    def create_and_check_model(
        ...
        model = FlaxStarcoder2Model(config=config)
    ...
    def create_and_check_lm_head(
        ...
        model = FlaxStarcoder2ForCausalLM(config=config)
        inputs = {
            "input_ids": input_ids,
    ...
    def create_and_check_for_masked_lm(
        ...
        model = FlaxStarcoder2ForMaskedLM(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
    ...
    def create_and_check_for_sequence_classification(
        ...
        model = FlaxStarcoder2ForSequenceClassification(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
    ...
    def create_and_check_for_multiple_choice(
        ...
        model = FlaxStarcoder2ForMultipleChoice(config=config)
    ...
    def create_and_check_for_token_classification(
        ...
        config.num_labels = self.num_labels
        model = FlaxStarcoder2ForTokenClassification(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
    ...
    def create_and_check_for_question_answering(
        ...
        model = FlaxStarcoder2ForQuestionAnswering(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
...
@require_flax
class FlaxStarcoder2ModelTest(FlaxModelTesterMixin, unittest.TestCase):
    ...
    def setUp(self):
        self.model_tester = FlaxStarcoder2ModelTester(self)
    ...
    def test_model_from_pretrained(self):
        model = FlaxStarcoder2Model.from_pretrained("bigcode/starcoder2-15b")
...
@require_flax
class FlaxStarcoder2ModelIntegrationTest(unittest.TestCase):
    @slow
    def test_inference_masked_lm(self):
        model = FlaxStarcoder2ForMaskedLM.from_pretrained("bigcode/starcoder2-15b")
