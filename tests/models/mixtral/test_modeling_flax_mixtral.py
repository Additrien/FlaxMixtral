...
from transformers import MixtralConfig, is_flax_available, is_tokenizers_available
...
if is_flax_available():
    ...
    from transformers.models.mixtral.modeling_flax_mixtral import FlaxMixtralForCausalLM, FlaxMixtralModel
...
@require_flax
class FlaxMixtralModelTest(FlaxModelTesterMixin, FlaxGenerationTesterMixin, unittest.TestCase):
    all_model_classes = (FlaxMixtralModel, FlaxMixtralForCausalLM) if is_flax_available() else ()
    all_generative_model_classes = (FlaxMixtralForCausalLM,) if is_flax_available() else ()

    def setUp(self):
        self.model_tester = FlaxMixtralModelTester(self)
